...
def display_medication_info():
    ...
    for row in medication_data:
        label_medication_name = tk.Label(top, text=row, font=("Arial", 12), fg="#333333", bg="#FFFFFF")
...
def add_medication():
    ...
    label_medication_name = tk.Label(top1, text="Medication Name:", font=("Arial", 12), fg="#333333", bg="#E8F6F3")
    label_medication_name.pack(pady=5)
    entry_medication_name = tk.Entry(top1, font=("Arial", 12))
    entry_medication_name.pack(pady=5)

    label_dosage = tk.Label(top1, text="Dosage:", font=("Arial", 12), fg="#333333", bg="#E8F6F3")
    label_dosage.pack(pady=5)
    entry_dosage = tk.Entry(top1, font=("Arial", 12))
    entry_dosage.pack(pady=5)

    label_frequency = tk.Label(top1, text="Frequency:", font=("Arial", 12), fg="#333333", bg="#E8F6F3")
    label_frequency.pack(pady=5)
    entry_frequency = tk.Entry(top1, font=("Arial", 12))
    entry_frequency.pack(pady=5)

    label_schedule_time = tk.Label(top1, text="Schedule Time:", font=("Arial", 12), fg="#333333", bg="#E8F6F3")
    label_schedule_time.pack(pady=5)
    entry_schedule_time = tk.Entry(top1, font=("Arial", 12))
    entry_schedule_time.pack(pady=5)

    button_add_medication = tk.Button(top1, text="Add Medication", command=add_medication_schedule, font=("Arial", 12), fg="#FFFFFF", bg="#1ABC9C")
...
def display_medication():
    ...
    top.config(bg='#E8F6F3')

    # Medication Schedule Form
    label_medication_name = tk.Label(top, text='Display Medication', font=("Arial", 16), fg="#333333", bg="#E8F6F3")
    label_medication_name.pack(pady=10)

    label_medication_info_btn = tk.Button(top, text='Click to view Medication', command=display_medication_info, font=("Arial", 12), fg="#FFFFFF", bg="#1ABC9C")
...
label = tk.Label(window, text="Medication Reminder App", font=("Arial", 20), pady=20, bg='#E8F6F3', fg='#1ABC9C')
label.pack()
...
style = ttk.Style()
style.configure("Custom.TButton", font=("Arial", 12), foreground="#FFFFFF", background="#1ABC9C", relief="raised")
style.map("Custom.TButton", foreground=[('active', 'red'), ('disabled', 'gray')], background=[('active', '#16A085'), ('disabled', 'gray')])
